...
export const ALL_PRODUCT_REQUESTC = "ALL_PRODUCT_REQUESTC";
export const ALL_PRODUCT_SUCCESSC = "ALL_PRODUCT_SUCCESSC";
export const ALL_PRODUCT_FAILC = "ALL_PRODUCT_FAILC";
